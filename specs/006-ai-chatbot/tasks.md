...
- [ ] T004 [P] Run database migration for new tables
...
- [ ] T009 [P] [US2] Create ChatRequest/ChatResponse types in frontend/types/chat.ts
- [ ] T010 [P] [US2] Implement sendChatMessage in frontend/lib/api.ts
- [ ] T011 [P] [US2] Create useChat hook in frontend/hooks/useChat.ts
- [ ] T012 [P] [US2] Build ChatInterface component in frontend/components/chat/ChatInterface.tsx
- [ ] T013 [US2] Create chat page in frontend/app/chat/page.tsx
- [ ] T014 [US2] Add chat link to frontend/components/layout/Navbar.tsx

## Phase 5: Polish & Cross-cutting
- [ ] T015 [P] Implement input validation in backend/routes/chat.py
- [ ] T016 [P] Ensure task sync with existing dashboard logic
